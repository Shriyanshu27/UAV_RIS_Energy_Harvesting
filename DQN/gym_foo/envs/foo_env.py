...
class FooEnv(gym.Env):
    ...
    def __init__(self, LoadData=True, Train=False, multiUT=True, Trajectory_mode='Kmeans', MaxStep=41):
        ...
        # Use MultiDiscrete for RIS elements (0 for harvesting, 1 for reflecting)
        self.action_space = spaces.MultiDiscrete([2] * globe.get_value('RIS_L'))
    ...
    def step(self, action):
        ...
        Omega_R = action[4 + globe.get_value('RIS_L'):]
