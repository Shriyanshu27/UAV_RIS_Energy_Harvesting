...
class FooEnv(gym.Env):
    ...
    def __init__(self, LoadData = True, Train = False, multiUT = True, Trajectory_mode = 'Kmeans', MaxStep = 41):
            ...
            if Train == True:
                ...
                if multiUT == True:
                    ...
                    if Trajectory_mode == 'Fermat':
                        ...
                        UAV_Trajectory = np.loadtxt("../CreateData/Lemoine_Test_Trajectory_3.csv", delimiter=",")
        ...
        self.Train = Train
        self.multiUT = multiUT
        self.Trajectory_mode = Trajectory_mode
        self.MaxStep = MaxStep
        self.memory = []  # Memory for storing experiences
        self.init_env()  # Initialize the environment settings
    ...
    def step(self, action):
        ...
        goal = self.current_goal()  # Function to define the current goal
        achieved_goal = self.current_state()  # This would typically be the state that the agent achieves
        self.memory.append((self.state, action, reward, next_state, done, goal, achieved_goal))
